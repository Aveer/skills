...
Read the repository's TypeScript configuration, module topology, formatter,
test framework, and local conventions first. This skill is advisory: do not
impose barrel files, a test framework, error-handling style, or file layout that
conflicts with project guidance. Prefer installed tools and project scripts over
generic examples.
